...
original.yaml: target.yaml
	cp target.yaml original.yaml
# curl https://docs.api.epilot.io/target.yaml > original.yaml
...
speakeasy: target.yaml
	$(eval TMP := $(shell mktemp -d))
	cp target.yaml $(TMP)/openapi.yaml
# curl https://docs.api.epilot.io/target.yaml > $(TMP)/openapi.yaml
